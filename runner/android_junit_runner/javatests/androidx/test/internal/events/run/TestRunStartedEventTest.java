...
public class TestRunStartedEventTest {
  ...
  public void testRunStartedEvent_created_by_createFromParcel() {
    ...
    TestRunStartedEvent testRunStartedEvent = new TestRunStartedEvent(testCase);
    ...
    assertThat(testRunEventFromParcel).isInstanceOf(TestRunStartedEvent.class);

    TestRunStartedEvent result = (TestRunStartedEvent) testRunEventFromParcel;
