...
package androidx.test.internal.events.run;

import static com.google.common.truth.Truth.assertThat;

import android.os.Parcel;
import androidx.test.ext.junit.runners.AndroidJUnit4;
import androidx.test.internal.events.FailureInfo;
import androidx.test.internal.events.TestCaseInfo;
import java.util.ArrayList;
import org.junit.Test;
import org.junit.runner.RunWith;

/**
 * Unit tests for the {@link TestFailureEvent} parcelable. We write and read from the parcel to
 * verify that {@link TestRunEvent#CREATOR} instantiates it correctly.
 */
@RunWith(AndroidJUnit4.class)
public class TestFailureEventTest {

  @Test
  public void testFailureEvent_created_by_createFromParcel() {
    ...
    TestFailureEvent testFailureEvent = new TestFailureEvent(testCase, failure);
    ...
    assertThat(testRunEventFromParcel).isInstanceOf(TestFailureEvent.class);

    TestFailureEvent result = (TestFailureEvent) testRunEventFromParcel;
